...
Feature: Pagina de portal salud
  Como usuario deseo realizar pago de una de cita medica presencial con tarjeta de credito
  	
		
  Scenario: Ingresar al modulo de salud y realizar pago de cita medica presencial con tarjeta de credito
    ...
    And Selecciona opcion de credito, ingresa numero de cuenta, ingresa numero de agencia y contraseña
