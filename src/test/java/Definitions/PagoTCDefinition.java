...
import Steps.PagoTCStep;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;
import cucumber.api.java.en.When;
import net.thucydides.core.annotations.Steps;

public class PagoTCDefinition {
	
	@Steps
	PagoTCStep AgendamientoStep;
	...
	@When("^Selecciona opcion de credito, ingresa numero de cuenta, ingresa numero de agencia y contraseña$")
	public void selecciona_opcion_de_debito_ingresa_numero_de_cuenta_ingresa_numero_de_agencia_y_contraseña() throws Throwable {
		AgendamientoStep.IngresoInformacionTC();
	}
